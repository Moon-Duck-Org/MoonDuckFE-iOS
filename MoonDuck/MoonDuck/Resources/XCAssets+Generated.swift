...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let categoryBookSmall = ImageAsset(name: "CategoryBookSmall")
    ...
    internal static let categoryConcertSmall = ImageAsset(name: "CategoryConcertSmall")
    ...
    internal static let categoryDramaSmall = ImageAsset(name: "CategoryDramaSmall")
    ...
    internal static let categoryMovieSmall = ImageAsset(name: "CategoryMovieSmall")
